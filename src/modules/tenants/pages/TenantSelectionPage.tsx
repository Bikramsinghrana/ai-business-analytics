...
import { Building2, Check, ArrowRight, Plus } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950 p-6">
      <div className="w-full max-w-2xl space-y-6">
        <div className="text-center space-y-2">
          <h1 className="text-3xl font-extrabold text-white">Select Active Tenant</h1>
          <p className="text-sm text-slate-400">Choose an organization environment or register a new tenant</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {tenants.map((t) => (
            <Card
              ...
              className={`p-6 cursor-pointer border transition flex flex-col justify-between space-y-4 ${
