...
export const SEARCH_TYPE_OPTIONS: SearchTypeOption[] = [
  {
    ...
    badge: 'Web',
    iconName: 'Globe',
    description: 'Web search for up-to-date facts and articles',
  },
  {
  ...
  },
  {
    ...
    badge: 'Code',
    iconName: 'FolderGit2',
    description: 'Architecture, codebase, routes & frontend',
  },
  {
  ...
  },
  {
    ...
    badge: 'Business',
    iconName: 'Database',
    description: 'Live SQL queries for orders, revenue & tickets',
  },
  {
    ...
    badge: 'Weather',
    iconName: 'CloudSun',
    description: 'Meteorological forecast & temperature',
  },
  {
